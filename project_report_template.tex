...
\title{The O-star: An ontology and LLM-based system for astronomical knowledge retrieval}
\author{Adrian Fyrpil, Jakob Jack Loula, Ahmed Hussein, Sherbal Al Khouri, Jorge Curello Tejero}
